#pragma once
 ...
 //// BOARD FEATURES
  ...
  #ifdef ESP32_C3_SM  // No display at this time. Use with flipper zero
    //#define FLIPPER_ZERO_HAT
    //#define HAS_BATTERY
    #define HAS_BT
    #define HAS_BUTTONS
  ...
  //// BUTTON DEFINITIONS
    ...
    #ifdef ESP32_C3_SM  // Edit these pins to match the GPIO pins of board (No buttons at this time. Use flipper zero)
      #define L_BTN -1
      #define C_BTN 10
      #define U_BTN -1
      #define R_BTN -1
    ...
    #ifdef MARAUDER_TTGO_TDISPLAY  // Edit these pins to match the button GPIO pins of board
      #define L_BTN -1
      #define C_BTN 35 
      #define U_BTN -1
      #define R_BTN -1
  ...
  //// SD DEFINITIONS
    ...
    #ifdef ESP32_C3_SM  // Edit this pin to match the GPIO pin
      #define SD_CS 3
    #endif

    #ifdef MARAUDER_TTGO_TDISPLAY  // Edit this pin to match the GPIO pin
      #define SD_CS 33
    #endif
  ...
  // These values are in bytes
    ...
    #define MEM_LOWER_LIM 10000
  #else
    #define MEM_LOWER_LIM 10000  // Minimum free heap size in bytes before memory check fails
  #endif
  ...
  //// GPS STUFF
      ...
      #define GPS_TX 6
      #define GPS_RX 9
    #elif defined(ESP32_C3_SM)  // Edit these pins to match the GPIO pins
      #define GPS_SERIAL_INDEX 1
      #define GPS_TX 6
      #define GPS_RX 9
