/* FLASH SETTINGS
Board: LOLIN D32 (For ESP32_C3_SM use ESP32C3 Dev Module. For MARAUDER_TTGO_TDISPLAY use LOLIN D32)
...
void setup()
{
  ...
  #ifdef ESP32_C3_SM
    Serial.begin(115200, SERIAL_8N1, 21, 20); // RX = GPIO21, TX = GPIO20 For use with ESP32C3SuperMini
  #else
    Serial.begin(115200);
  #endif
