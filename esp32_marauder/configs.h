#pragma once
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "FlipperZero S2MINI"
 ...
 //// BOARD FEATURES
  ...
  //// GPS STUFF
    ...
    // Exclude ESP32_C3_SM and MARAUDER_TTGO_TDISPLAY //------------------------------ Added for ESP32_C3_SM --------------------------------------------
    // #if !defined(ESP32_C3_SM) && !defined(MARAUDER_TTGO_TDISPLAY)
    //   #define mac_history_len_half (mac_history_len / 2)
    // #else
    //   // If excluded, you may want to use an alternative value or skip it
    //   #define mac_history_len_half (mac_history_len) // Or some default value
    // #endif
