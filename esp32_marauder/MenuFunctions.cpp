...
void MenuFunctions::updateStatusBar()
{
  ...
  #if defined(MARAUDER_MINI) || defined(MARAUDER_M5STICKC) || defined(MARAUDER_REV_FEATHER) || defined(MARAUDER_CARDPUTER) || defined(MARAUDER_CARDPUTER_ADV) || defined(MARAUDER_MINI_V3) || defined(MARAUDER_S2MINI)
    display_obj.tft.setFreeFont(NULL);
  #endif
