...
// Preset SPI CS pins to avoid bus conflicts
  ...
  */
  ...
  display_obj.tft.drawCentreString("Ported by ATOMNFT", TFT_WIDTH / 1.1, TFT_HEIGHT * 0.27, 1);  // Added this line
#endif
...
// Do some stealth mode stuff
  ...
  display_obj.tft.drawCentreString("Initializing...", TFT_WIDTH / 1.1, TFT_HEIGHT * 0.38, 1);
#endif
